...
export class SeoService {
  private baseUrl = "https://my-portfolio-sage-seven-13.vercel.app/resume";
  private siteName = "Debojyoti Bhattacherjee Portfolio";
      ...
      .subscribe((route) => {
        ...
        if (routeData) {
          ...
          this.updatePageMetadata({
            title: routeData["title"] || "Debojyoti Bhattacherjee | Full-Stack Developer |  | Portfolio",
  ...
  updatePageMetadata(metadata: PageMetadata): void {
    ...
    const formattedTitle =
      metadata.title === "Home"
        ? "Debojyoti Bhattacherjee | Full-Stack Developer"
  ...
  updateTitle(title: string): void {
    const formattedTitle =
      title === "Home" ? "Debojyoti Bhattacherjee | Full-Stack Developer" : `${title} – ${this.siteName}`;
    this.title.setTitle(formattedTitle);
  }
  ...
  updateSeoForRoute(route: string, metadata: Partial<PageMetadata>): void {
    ...
    this.updatePageMetadata({
      title: metadata.title || "Debojyoti Bhattacherjee | Full-Stack Developer | Portfolio",
