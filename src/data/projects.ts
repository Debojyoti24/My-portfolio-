...
export const projects: Project[] = [
  {
    ...
    title: "Pulseboard",
    description:
      "Real-time analytics dashboard with sub-second streaming metrics, custom alerting, and shareable report snapshots.",
    category: "Web App",
  ...
  },
  {
    ...
    title: "Ledgerly",
    description:
      "Multi-tenant invoicing and billing platform with Stripe integration, PDF generation, and automated dunning flows.",
    category: "Web App",
